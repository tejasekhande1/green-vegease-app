...
class _CancellationPolicyPageState extends State<CancellationPolicyPage> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: const AppBarWidget(title1: "Cancellation policy" ),
      ),
