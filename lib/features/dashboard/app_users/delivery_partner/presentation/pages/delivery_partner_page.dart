...
import 'package:green_vegease/features/dashboard/app_users/delivery_partner/presentation/widgets/delivery_partner_card_widget.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return DeliveryPartnerCardWidget(                     // ----------------> Delivery Partner Info Card
